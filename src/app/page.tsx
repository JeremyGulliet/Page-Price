    ...
    <main className="flex justify-center bg-[#010B25] text-white">
      ...
      >
        <motion.h6
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className="flex items center justify-center bg-gradient-to-r from-[#0738B966] to-[#03195366] w-[150px] mt-[34px] p-1 rounded-[54.99px] border border-white/60"
        >
          Nos offres
        </motion.h6>
        <motion.h1
        ...
        >
          <Button
            ...
            className={`w-[275px] h-[45px] rounded-[9.17px] transition ease-in-out duration-150 hover:scale-105 ${
