...
export default function CardPricesMonth() {
  const [currency, setCurrency] = useState("EUR");

  // Fonction pour convertir le prix
  const convertPrice = (priceInEuros: number) => {
    switch (currency) {
      case "USD":
        return (priceInEuros * 1.1).toFixed(2); // Exemple de taux de conversion
      case "GBP":
